...
import { createTestimonial, type TestimonialFormState } from '@/lib/actions/testimonialActions'
  ...
  return (
    <div className='p-8'>
      ...
      <div className='max-w-6xl mx-auto'>
        ...
        {/* Title */}
        <div className="mb-8">
          <h1 className="text-5xl font-Dongle text-amber-900">Nuevo Testimonio</h1>
          <p className="text-lg text-amber-700/60 font-DMSans">Crea un nuevo testimonio para tu sitio web</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-9">
          <form action={formAction} className="space-y-6">
            ...
            <div className="flex gap-4 pt-4 justify-end w-full">
              ...
              >
                {isPending ? 'Creando...' : 'Crear Testimonio'}
              </button>
            </div>
          </form>
          {/* Preview Card */}
