...
interface TestimonialActiveSwitchProps {
  testimonialId: string
  initialActive: boolean
}

export function TestimonialActiveSwitch({ testimonialId, initialActive }: TestimonialActiveSwitchProps) {
  ...
  const handleToggle = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    startTransition(async () => {
      try {
        await toggleTestimonialPublished(testimonialId, newValue)
      } catch (error) {
